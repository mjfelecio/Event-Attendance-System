...
INSERT INTO "new_Event" ("allDay", "category", "createdAt", "description", "end", "id", "includedGroups", "location", "start", "title", "updatedAt") SELECT "allDay", "category", "createdAt", "description", "end", "id", "includedGroups", "location", "start", "title", "updatedAt" FROM "Event";
DROP TABLE "Event";
