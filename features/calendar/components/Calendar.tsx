...
import { CALENDAR_CONFIG, CALENDAR_HEADER_TOOLBAR } from "@/features/calendar/constants/calendarConfig";
...
const Calendar = ({ onSelectDate, isDrawerOpen, onEditEvent }: CalendarProps) => {
  ...
  const { handleEventClick, handleEventResize, handleEventDrop } = useCalendarEvents(
    data,
    saveEvent,
    onEditEvent
  );
